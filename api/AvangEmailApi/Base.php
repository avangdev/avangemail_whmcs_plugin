<?php
/**
 * This file contains the base class for the AvangEmailApi PHP-SDK.
 *
...
/**
 * AvangEmailApi_Base is the base class for all the other classes used in the sdk.
 * 
 * @author Serban George Cristian <cristian.serban@mailwizz.com>
...
class AvangEmailApi_Base
{
    ...
    /**
     * @var AvangEmailApi_Config the configuration object injected into the application at runtime  
     */
    private static $_config;
    
    /**
     * @var AvangEmailApi_Params the package registry that will hold various components
     */
    private static $_registry = array();
    
    /**
     * @var AvangEmailApi_Params the registered event handlers
     */
     ...
     * 
     * @param AvangEmailApi_Config $config
     */
    public static function setConfig(AvangEmailApi_Config $config)
    {
        self::$_config = $config;
    }
     ...
     * 
     * @return AvangEmailApi_Params
     */
    public function getRegistry()
    {
        if (!(self::$_registry instanceof AvangEmailApi_Params)) {
            self::$_registry = new AvangEmailApi_Params(self::$_registry);
        }
     ...
     * $components = array(
     *     'cache'=>array(
     *         'class'             => 'AvangEmailApi_Cache_Sqlite',
    ...
    public function setComponent($componentName, array $config)
    {
        ...
        if ($component instanceof AvangEmailApi_Base) {
    ...
    {
        if (!(self::$_eventHandlers instanceof AvangEmailApi_Params)) {
            self::$_eventHandlers = new AvangEmailApi_Params(self::$_eventHandlers);
        }
        
        if (!self::$_eventHandlers->contains($eventName) || !(self::$_eventHandlers->itemAt($eventName) instanceof AvangEmailApi_Params)) {
            self::$_eventHandlers->add($eventName, new AvangEmailApi_Params());
        }
